...
//$connection_read = mysqli_connect($ip, $user, $password, $dbname);
  if (!mysqli_connect_errno()) {
    $query = "SELECT `id`,`name`,`address`,`specialist`,`mobile`,`svisit`,`evisit` FROM doctor";
    ...
    while ($row = mysqli_fetch_array($result, MYSQLI_BOTH)) {
      ...
      echo "<td>".$row['svisit']."</td>";
      echo "<td>".$row['evisit']."</td>";
      echo "</tr>";
  }
  echo "</table>";
    }
...
//$connection_read = mysqli_connect($ip, $user, $password, $dbname);
  if (!mysqli_connect_errno()) {
    $query = "SELECT count('name') as total from doctor";
    $result = mysqli_query($con, $query);
    if($result){
      echo "<table id='tbl'>
    <tr>
