...
<div class="container" style="margin-top:110px;margin-left: 100px; text-align:center;font-family:Verdana, Geneva, sans-serif;font-size:35px;">
...
<form method="post"  class="form-horizontal" role="form" align="center">
    <div class="form-group" align="center">
        ...
        <div class="col-sm-6">
            <input type="text" name="name" placeholder="Enter patient's name" required="true" class="form-control"/>
        </div>
    </div>  
    ...
    <div class="form-group">
        ...
        <div class="col-sm-6">            
            <input type="text" name="gen" placeholder="Enter gender type" required="true" class="form-control"/> 
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-sm-4" for="jdate">Date</label>
        <div class="col-sm-6">            
            <input type="date" name="jdate" required="true" class="form-control"/>
        </div>
    </div>
 <div class="form-group">
        <label class="control-label col-sm-4" for="jdate">Room No</label>
        <div class="col-sm-6">            
            <input type="number" name="room" placeholder="Enter room number" required="true" class="form-control"/>
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-sm-4" for="mobile">Mobile</label>
        <div class="col-sm-6">            
            <input type="number" name="mobile" placeholder="Enter mobile number" required="true" class="form-control"/> 
        </div>
    </div>
    <div class="form-group"> 
