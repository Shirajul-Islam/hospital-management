...
<nav class="navbar navbar-inverse navbar-fixed-top">
    ...
    <h3 style="color:   #A52A2A;">Appointment list</h3>
...
//$con = mysqli_connect($ip, $user, $password, $dbname);
  if (!mysqli_connect_errno()) {
    $query = "SELECT * FROM appointment WHERE `visible` = 1";
    ...
    while ($row = mysqli_fetch_array($result, MYSQLI_BOTH)) {
      ...
      echo "<td>".$row['time']."</td>";
      echo "<td>"."<a href = 'update-appointment.php?id=$id' id='update'>EDIT</a>"."</td>";
      echo "<td>"."<a href = 'delete-appointment.php?id=$id' id='delete'>DEL</a>"."</td>";
      echo "</tr>";
  }
  echo "</table>";
    }
