...
<div class="container" style="margin-top:150px;margin-left: 100px; text-align:center;font-family:Verdana, Geneva, sans-serif;font-size:35px;">
  <p>Hospital Management System</p>
    ...
    <div style="background-color:white; margin-left: 310px;width:800px; border-style:groove; border-color:#FF0099" align="center">
        ...
        <h3 style="color:#CC3300;"><b>Add New Appointment</b></h3></div>
         <hr>
<form method="post"  class="form-horizontal" role="form" align="center">
    <div class="form-group" align="center">
        ...
        <div class="col-sm-6">
            <input type="text" name="pname" placeholder="Enter patient's name" required="true" class="form-control"/>
        </div>
    </div>  
    <div class="form-group">
        <label class="control-label col-sm-4" for="dname">Doctor's name</label>
        <div class="col-sm-6">            
            <input type="text" name="dname" placeholder="Enter doctor's name" required="true" class="form-control"/> 
        </div>
    </div>
    
    <div class="form-group">
        <label class="control-label col-sm-4" for="adate">Appointment date</label>
        <div class="col-sm-6">            
            <input type="date" name="adate" required="true" class="form-control"/> 
        </div>
    </div>

    <div class="form-group">
        <label class="control-label col-sm-4" for="adate">Appointment time</label>
        <div class="col-sm-6">            
